...
async function checkMeetingMetadata(meetUrl: string): Promise<{hasIndicators: boolean, [key: string]: any}> {
  try {
...
function validateScheduleForDetection(schedule: any, currentDay: number, currentTime: number): {valid: boolean, reason?: string} {
  try {
